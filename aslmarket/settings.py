"""
Django settings for aslmarket project.
...
SECRET_KEY = 'django-insecure-6&2$58c3pj4x9^0mk5zojk^ytqn#mdva$2uj^rn_tj%ycn35oz'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'store.context_processors.panel_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'aslmarket.wsgi.application'
